...
const rule = createOxlintRuleHarness("notcodex/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("notcodex/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("notcodex/no-manual-effect-runtime-in-tests");
