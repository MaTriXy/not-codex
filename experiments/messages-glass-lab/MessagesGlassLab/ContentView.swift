...
private let threads: [LabThread] = [
    .init(title: "Markdown rendering test", subtitle: "notcodex · Collaborator’s Mac mini", time: "14h", initials: "MD", tint: .blue, preview: "Renderer stress test, terminal snippets, code blocks, and a very long markdown transcript."),
    .init(title: "iPad rectly text correction", subtitle: "Collaborator’s Mac mini · main", time: "16h", initials: "IP", tint: .purple, preview: "Fix iPad layout, search behavior, hardware keyboard, and trackpad scrolling."),
    .init(title: "Preview Webview Persists Off Panel", subtitle: "example-repo · Collaborator’s MacBook Pro", time: "22m", initials: "PW", tint: .teal, preview: "The browser preview should not leak outside the active panel when switching threads."),
    ...
    .init(title: "Fix dark-mode header glass", subtitle: "notcodex/ipad-responsive-mobile-layout", time: "2h", initials: "DG", tint: .indigo, preview: "Compare dark scroll-edge material against Messages and Mail, then map the behavior back to React Native Screens."),
