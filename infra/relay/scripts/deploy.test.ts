...
describe("reconcileRootEnvPublicConfig", () => {
  const config = {
    ...
    mobileTracingUrl: "https://api.axiom.co/v1/traces",
    mobileTracingDataset: "notcodex-mobile-traces-dev",
    mobileTracingToken: "xaat-public-ingest",
    clientTracingUrl: "https://api.axiom.co/v1/traces",
    clientTracingDataset: "notcodex-relay-client-traces-dev",
  ...
  it("adds the complete local client config", () => {
    expect(reconcileRootEnvPublicConfig("", config)).toBe(
      [
        ...
        "NOT_CODEX_MOBILE_OTLP_TRACES_DATASET=notcodex-mobile-traces-dev",
        "NOT_CODEX_MOBILE_OTLP_TRACES_TOKEN=xaat-public-ingest",
        "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_URL=https://api.axiom.co/v1/traces",
        "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_DATASET=notcodex-relay-client-traces-dev",
        "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_TOKEN=xaat-relay-client-ingest",
        "",
      ].join("\n"),
    );
  });
    ...
    expect(
      reconcileRootEnvPublicConfig(
        [
          "NOT_CODEX_CLERK_PUBLISHABLE_KEY=pk_test_example",
          "NOT_CODEX_RELAY_URL=https://old.example.test",
          "NOT_CODEX_MOBILE_OTLP_TRACES_URL=https://old.example.test/v1/traces",
          "NOT_CODEX_MOBILE_OTLP_TRACES_DATASET=old-dataset",
          "NOT_CODEX_MOBILE_OTLP_TRACES_TOKEN=old-token",
          "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_URL=https://old.example.test/v1/traces",
          "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_DATASET=old-client-dataset",
          "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_TOKEN=old-client-token",
          "",
        ].join("\n"),
        config,
      ),
...
describe("serializeRelayClientTracingEnvironment", () => {
  it("serializes tracing config for downstream GITHUB_ENV loading", () => {
    expect(
      ...
      [
        "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_URL=https://api.axiom.co/v1/traces",
        "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_DATASET=relay",
        "NOT_CODEX_RELAY_CLIENT_OTLP_TRACES_TOKEN=client-token",
        "",
      ].join("\n"),
    );
  });
