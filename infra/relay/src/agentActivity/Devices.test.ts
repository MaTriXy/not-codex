import type { RelayDeviceRegistrationRequest } from "@notcodex/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.notcodex.notcodex.preview" as RelayDeviceRegistrationRequest["bundleId"],
    ...
    return Effect.gen(function* () {
      ...
      expect(insertedValues).toEqual([
        expect.objectContaining({
          userId: "user-2",
          deviceId: "device-1",
          bundleId: "com.notcodex.notcodex.preview",
          apsEnvironment: "production",
