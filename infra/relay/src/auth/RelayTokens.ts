...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@notcodex/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "notcodex-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "notcodex-relay-dpop-access+jwt";
...
>()("notcodex-relay/auth/RelayTokens") {}
