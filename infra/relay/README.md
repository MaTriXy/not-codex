...
See the [Not Codex Connect architecture overview](../../docs/cloud/notcodex-connect-auth-flow.html) for the larger system
design.
...
- [Not Codex Connect Clerk Setup](../../docs/cloud/not-codex-connect-clerk.md) for Clerk keys, JWT templates, and waitlist
  setup.
- [Relay Observability](../../docs/relay-observability.md) for deployment tracing and diagnostics.
- [Not Codex Connect Architecture Overview](../../docs/cloud/notcodex-connect-auth-flow.html) for the full link,
