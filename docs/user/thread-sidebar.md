...
in the sidebar. The thread settles when the linked pull request merges if automatic settlement is
enabled. Right-click the same link and choose **Unlink from thread** to remove it.
