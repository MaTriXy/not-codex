...
This guide is for people who want to use more than one Codex account in Not Codex.
...
- both accounts can see the same Not Codex/Codex sessions
...
In Not Codex Settings, name it something obvious:
...
In Not Codex Settings, add another Codex provider:
...
Not Codex shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, Not Codex treats it
