...
### `apps/server/src/git/GitManager.ts` (`58`)

- [x] [makeGitCore](../../apps/server/src/git/GitManager.ts#L513)
- [x] [handleTraceLine](../../apps/server/src/git/GitManager.ts#L324)
- [x] [emitCompleteLines](../../apps/server/src/git/GitManager.ts#L455)
- [x] [commit](../../apps/server/src/git/GitManager.ts#L1190)
- [x] [pushCurrentBranch](../../apps/server/src/git/GitManager.ts#L1223)
- [x] [pullCurrentBranch](../../apps/server/src/git/GitManager.ts#L1323)
- [x] [checkoutBranch](../../apps/server/src/git/GitManager.ts#L1727)
- [x] Service methods and callback wrappers in this file

### `apps/server/src/git/GitManager.ts` (`28`)

- [x] [configurePullRequestHeadUpstream](../../apps/server/src/git/GitManager.ts#L387)
- [x] [materializePullRequestHeadBranch](../../apps/server/src/git/GitManager.ts#L428)
- [x] [findOpenPr](../../apps/server/src/git/GitManager.ts#L576)
- [x] [findLatestPr](../../apps/server/src/git/GitManager.ts#L602)
- [x] [runCommitStep](../../apps/server/src/git/GitManager.ts#L728)
- [x] [runPrStep](../../apps/server/src/git/GitManager.ts#L842)
- [x] [runFeatureBranchStep](../../apps/server/src/git/GitManager.ts#L1106)
...
- [ ] [apps/server/src/bin.ts](../../apps/server/src/bin.ts) (`4`)
...
- [ ] [apps/server/src/bootstrap.ts](../../apps/server/src/bootstrap.ts) (`3`)
...
- [ ] [apps/server/src/bootstrap.ts](../../apps/server/src/bootstrap.ts) (`2`)
