...
// Recover a crashed renderer after a short delay, but bound retries in a
// rolling window so a renderer that dies during boot cannot reload forever.
...
>()("@notcodex/desktop/window/DesktopWindow") {}
