import type { DesktopSshPasswordPromptRequest } from "@notcodex/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@notcodex/contracts";
import type { SshPasswordRequest } from "@notcodex/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Not Codex window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@notcodex/desktop/ssh/DesktopSshPasswordPrompts") {}
