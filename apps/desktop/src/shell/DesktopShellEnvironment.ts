...
>()("@notcodex/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__NOT_CODEX_ENV_${name}_START__`;
const endMarker = (name: string) => `__NOT_CODEX_ENV_${name}_END__`;
