...
import { resolveRemoteNotCodexCliPackageSpec } from "@notcodex/ssh/command";
import type { RemoteNotCodexRunnerOptions } from "@notcodex/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteNotCodexRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteNotCodexServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteNotCodexCliPackageSpec({
