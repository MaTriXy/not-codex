...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteNotCodexServerEntryPath: Option.Option<string>;
...
>()("@notcodex/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Not Codex";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteNotCodexServerEntryPath: config.devRemoteNotCodexServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.notcodex.notcodex.dev" : "com.notcodex.notcodex",
    ),
    linuxDesktopEntryName: isDevelopment ? "notcodex-dev.desktop" : "notcodex.desktop",
    linuxWmClass: isDevelopment ? "notcodex-dev" : "notcodex",
    userDataDirName,
