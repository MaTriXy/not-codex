import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@notcodex/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@notcodex/shared/observability";
...
>()("@notcodex/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
