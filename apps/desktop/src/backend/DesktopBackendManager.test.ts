  ...
  it.effect("retries HTTP readiness before reporting the backend ready", () =>
    Effect.scoped(
      Effect.gen(function* () {
        ...
        assert.deepEqual(requestUrls, ["http://127.0.0.1:3773/.well-known/notcodex/environment"]);
        ...
        assert.deepEqual(requestUrls, [
          "http://127.0.0.1:3773/.well-known/notcodex/environment",
          "http://127.0.0.1:3773/.well-known/notcodex/environment",
        ]);
