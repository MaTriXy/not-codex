...
import { waitForHttpReady as waitForHttpReadyShared } from "@notcodex/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/notcodex/environment";
...
export interface DesktopBackendStartConfig {
  ...
  // NOT_CODEX_HOME can't pin the WSL backend to /mnt/c/...\.notcodex.
