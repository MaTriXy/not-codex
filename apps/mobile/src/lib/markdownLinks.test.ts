...
describe("resolveMarkdownLinkPresentation", () => {
  ...
  it("renders file URLs as basename pills with positions", () => {
    expect(
      resolveMarkdownLinkPresentation("file:///Users/collaborator/project/src/main.ts#L42C7"),
    ).toEqual({
      kind: "file",
      href: "file:///Users/collaborator/project/src/main.ts#L42C7",
      icon: "typescript",
      label: "main.ts:42:7",
      path: "/Users/collaborator/project/src/main.ts",
      line: 42,
      column: 7,
    });
  });
