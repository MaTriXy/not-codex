...
const PREFERENCES_KEY = "notcodex.preferences";
const PREFERENCES_FALLBACK_KEY = "notcodex.preferences.fallback";
...
>()("@notcodex/mobile/persistence/MobilePreferencesStore") {}
