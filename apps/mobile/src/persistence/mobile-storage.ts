...
const CONNECTIONS_KEY = "notcodex.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "notcodex.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "notcodex.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "notcodex.recent-thread-shortcuts";
...
>()("@notcodex/mobile/persistence/MobileStorage") {}
