...
import { ConnectionTransientError } from "@notcodex/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "notcodex.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "notcodex.connections";
