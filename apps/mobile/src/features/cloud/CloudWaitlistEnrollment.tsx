  ...
  if (waitlist.id) {
    return (
      <View className="gap-[18px]">
        <Text className="text-center font-notcodex-bold text-xl text-foreground">
          You are on the waitlist
        </Text>
        <Text className="text-center font-sans text-base text-foreground-secondary">
          We will email you when your Not Codex Connect access is ready.
        </Text>
  ...
  return (
    <View className="gap-[18px]">
      ...
      <View className="gap-2">
        <Text className="font-notcodex-bold text-sm text-foreground-secondary">Email address</Text>
        <TextInput
      ...
      >
        ...
        <Text className="font-notcodex-bold text-base text-primary-foreground">
  ...
  return (
    <View className="flex-row items-center justify-center gap-1 pt-1">
      ...
      <Pressable accessibilityRole="button" hitSlop={8} onPress={props.onPress}>
        <Text className="font-notcodex-bold text-base text-foreground">Sign in</Text>
      </Pressable>
    </View>
  );
}
