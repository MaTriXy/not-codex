...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.notcodex.bpro.dev/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.notcodex.bpro.dev",
  wsBaseUrl: "wss://pocket-pi.notcodex.bpro.dev",
  providerKind: "notcodex_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.notcodex.bpro.dev",
    isRelayManaged: true,
