...
function ModelRow(props: {
  ...
  return (
    ...
    >
      <Text
        className={cn(
          "shrink text-sm font-notcodex-medium",
...
function ProviderHeader(props: {
  ...
  return (
    ...
    >
      ...
      <Text className="text-2xs font-notcodex-bold uppercase tracking-widest text-foreground-muted">
        {props.label}
      </Text>
      {props.collapsible ? (
        <>
        ...
        {submenuContent ? (
          <View className="absolute inset-0 justify-end">
            ...
            <View className="overflow-hidden rounded-t-[24px] border border-b-0 border-border bg-sheet">
              ...
              <Text className="px-5 pb-1.5 text-2xs font-notcodex-bold uppercase tracking-widest text-foreground-muted">
