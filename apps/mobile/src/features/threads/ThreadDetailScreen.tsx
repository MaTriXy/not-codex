...
import type { EnvironmentThreadStatus } from "@notcodex/client-runtime/state/threads";
...
import { formatElapsed } from "@notcodex/shared/orchestrationTiming";
    ...
    >
      <View className="self-start rounded-full border border-neutral-200/80 bg-neutral-50/90 px-3 py-2 dark:border-white/[0.08] dark:bg-white/[0.04]">
        <View className="flex-row items-center gap-2">
          ...
          <Text className="font-notcodex-medium text-xs text-neutral-600 dark:text-neutral-400">
