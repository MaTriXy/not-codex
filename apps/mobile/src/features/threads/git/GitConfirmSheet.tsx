import { resolveDefaultBranchActionDialogCopy } from "@notcodex/client-runtime/state/vcs";
import { resolveAutoFeatureBranchName } from "@notcodex/shared/git";
  ...
  return (
    <View collapsable={false} className="flex-1 bg-sheet">
      ...
      <View className="items-center gap-1 px-5 pb-3 pt-4">
        <Text className="text-xs font-notcodex-bold tracking-[1px] uppercase text-foreground-muted">
          Confirm
        </Text>
        <Text className="text-center text-3xl font-notcodex-bold">
