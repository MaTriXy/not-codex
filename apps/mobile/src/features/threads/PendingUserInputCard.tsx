import type { ApprovalRequestId, UserInputQuestion } from "@notcodex/contracts";
...
export function PendingUserInputCard(props: PendingUserInputCardProps) {
  ...
  const card = renderCard ? (
    ...
    >
        ...
        {props.pendingUserInput.questions.map((question) => {
          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text className="font-notcodex-bold text-xs uppercase tracking-[1px] text-neutral-500 dark:text-neutral-500">
                {question.header}
              </Text>
      ...
      >
        <Text className="font-notcodex-extrabold text-sm text-white">Submit answers</Text>
      </Pressable>
    </Animated.View>
  ) : null;
  return (
