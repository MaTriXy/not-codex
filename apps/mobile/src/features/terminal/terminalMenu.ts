import { type KnownTerminalSession } from "@notcodex/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@notcodex/contracts";
...
} from "@notcodex/shared/terminalLabels";
