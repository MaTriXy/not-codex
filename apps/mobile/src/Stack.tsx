...
const SettingsContentStack = createNativeStackNavigator({
  ...
  screens: {
    ...
    SettingsLoopAny: createNativeStackScreen({
      screen: LoopAnySettingsRouteScreen,
      linking: "integrations/loopany/:environmentId",
      options: {
        title: "LoopAny",
      },
    }),
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-notcodex-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-notcodex-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
