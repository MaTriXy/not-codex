...
const customSprite = webIconSource.match(/const NOT_CODEX_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the Not Codex Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "notcodex-file-icon-agents",
  claude: "notcodex-file-icon-claude",
  package: "notcodex-file-icon-package-json",
  pnpm: "notcodex-file-icon-pnpm",
  readme: "notcodex-file-icon-readme",
  tsconfig: "notcodex-file-icon-tsconfig",
};
