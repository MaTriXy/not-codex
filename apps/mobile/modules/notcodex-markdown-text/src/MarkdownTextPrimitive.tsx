...
import NotCodexMarkdownTextRunNativeComponent from "./NotCodexMarkdownTextRunNativeComponent";
import NotCodexMarkdownTextNativeComponent from "./NotCodexMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <NotCodexMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <NotCodexMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
