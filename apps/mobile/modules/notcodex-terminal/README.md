# Not Codex Mobile Terminal Native Module
...
fork, with Not Codex's iOS 16 compatibility patch applied. `NotCodexTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/notcodex-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/notcodex-terminal/scripts/build-libghostty-android.sh
```
