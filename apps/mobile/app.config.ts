...
const isIosPersonalTeamBuild = repoEnv.NOT_CODEX_IOS_PERSONAL_TEAM === "1";

const personalTeamBundleIdentifier = repoEnv.NOT_CODEX_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "NOT_CODEX_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.notcodex when NOT_CODEX_IOS_PERSONAL_TEAM=1.",
  );
}
...
const DEVELOPMENT_ASSETS = {
  ...
  androidMonochromeIcon: "./assets/android-monochrome-icon.png",
  androidNotificationIcon: "./assets/android-notification-icon.png",
  androidNotificationColor: "#087CB7",
} as const;
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Not Codex agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    // Pin code signing to the Not Codex team so non-interactive `expo run:ios`
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Not Codex to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    relay: {
      url: repoEnv.NOT_CODEX_RELAY_URL ?? null,
    },
    clerk: {
