 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@notcodex/contracts";
...
>()("notcodex/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
