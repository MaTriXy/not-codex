  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `notcodex-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Not Codex",
        GIT_AUTHOR_EMAIL: "notcodex@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Not Codex",
        GIT_COMMITTER_EMAIL: "notcodex@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `notcodex checkpoint ref=${input.checkpointRef}`;
