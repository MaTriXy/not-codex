...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@notcodex/contracts";
import { VcsUnsupportedOperationError } from "@notcodex/contracts";
...
>()("notcodex/vcs/VcsDriverRegistry") {}
