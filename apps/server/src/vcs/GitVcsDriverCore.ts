...
import { dedupeRemoteBranchesWithLocalMatches } from "@notcodex/shared/git";
import { compactTraceAttributes } from "@notcodex/shared/observability";
import { decodeJsonResult } from "@notcodex/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `notcodex-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
