...
export interface ProcessRunOutput {
  ...
  /** Present on production output; optional for narrow test doubles. */
...
const runProcessCore = Effect.fn("processRunner.runProcessCore")(function* (
  ...
  return {
    ...
    stdoutInvalidUtf8: stdout.invalidUtf8 ?? false,
    stderrInvalidUtf8: stderr.invalidUtf8 ?? false,
  } satisfies ProcessRunOutput;
});
