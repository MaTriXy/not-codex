import { ProviderInstanceId, ThreadId } from "@notcodex/contracts";
...
export interface McpSessionRegistryShape {
  ...
  /** Refresh every credential associated with an active provider thread. */
...
>()("notcodex/mcp/McpSessionRegistry") {}
...
/**
 * Bounds credentials left behind by sessions that die without clean shutdown.
 * Provider turns and MCP traffic refresh this window; normal shutdown paths
 * still revoke credentials immediately.
 */
...
/** Keep an existing provider credential alive when its thread starts a turn. */
