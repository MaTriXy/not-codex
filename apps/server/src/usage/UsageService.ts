 ...
 *
 * The scan reads the provider CLIs' own session files rather than Not Codex's
 * orchestration projections, so usage covers turns driven outside Not Codex too.
