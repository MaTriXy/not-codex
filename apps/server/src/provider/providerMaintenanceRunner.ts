...
>()("notcodex/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Not Codex could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Not Codex still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
