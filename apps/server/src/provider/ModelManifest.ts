 ...
 */
import type { ProviderDriverKind, ServerProviderModel } from "@notcodex/contracts";
...
const MODEL_MANIFEST_URL =
  "https://raw.githubusercontent.com/MaTriXy/not-codex/main/apps/server/src/provider/model-manifest.json";
...
>()("notcodex/provider/ModelManifest") {}
