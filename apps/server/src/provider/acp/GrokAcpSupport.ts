import { type GrokSettings, ProviderDriverKind } from "@notcodex/contracts";
...
const NOT_CODEX_OAUTH_REFERRER = "notcodex";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: NOT_CODEX_OAUTH_REFERRER,
    },
  };
}
