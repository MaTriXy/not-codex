...
import { parseCliArgs } from "@notcodex/shared/cliArgs";
import {
  ApprovalRequestId,
...
function selectedClaudeContextWindow(
  ...
  const optionValue = resolveClaudeContextWindow(modelSelection);
  if (optionValue === "1m") {
    return 1_000_000;
  }
  if (optionValue === "200k") {
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleAskUserQuestion = Effect.fn("handleAskUserQuestion")(function* (
        ...
        // expected lookup key. See https://github.com/MaTriXy/not-codex/issues/2388
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @notcodex/shared/claudeCompaction because
