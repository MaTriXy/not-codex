  ...
  it.live("boots two independent codex instances from a ProviderInstanceConfigMap", () =>
    Effect.gen(function* () {
      ...
      const configMap: ProviderInstanceConfigMap = {
        [personalId]: {
          ...
          config: makeCodexConfig({
            ...
            homePath: "/home/collaborator/.codex_personal",
        ...
        [workId]: {
          ...
          config: makeCodexConfig({
            ...
            homePath: "/home/collaborator/.codex",
      ...
      expect(personalSnapshot.continuation?.groupKey).toBe(
        "codex:home:/home/collaborator/.codex_personal",
      );
      ...
      expect(workSnapshot.continuation?.groupKey).toBe("codex:home:/home/collaborator/.codex");
    ...
    Effect.gen(function* () {
      ...
      const configMap: ProviderInstanceConfigMap = {
        [codexId]: {
          ...
          displayName: "Codex",
          enabled: false,
          config: makeCodexConfig({ homePath: "/home/collaborator/.codex" }),
        },
        [claudeId]: {
          ...
          config: makeClaudeConfig({
            homePath: "/home/collaborator/.claude-work",
            launchArgs: "--verbose",
          }),
        },
        [cursorId]: {
      ...
      expect(codexSnapshot.continuation?.groupKey).toBe("codex:home:/home/collaborator/.codex");
      ...
      expect(claudeSnapshot.continuation?.groupKey).toBe(
        "claude:home:/home/collaborator/.claude-work",
      );
