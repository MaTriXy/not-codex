          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  NOT_CODEX_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(
                    /^Bearer\s+/,
                    "",
                  ),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.notcodex.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.notcodex.bearer_token_env_var="NOT_CODEX_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
