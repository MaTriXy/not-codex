 ...
 */
import { type RemoteOpenTarget } from "@notcodex/contracts";
import { HostProcessHostname } from "@notcodex/shared/hostProcess";
import * as NetService from "@notcodex/shared/Net";
import { readTailscaleStatus } from "@notcodex/tailscale";
...
>()("notcodex/environment/RemoteOpenTargets") {}
