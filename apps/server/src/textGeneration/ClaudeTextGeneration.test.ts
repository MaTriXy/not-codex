...
function withFakeClaudeEnv<A, E, R>(
  ...
  return Effect.gen(function* () {
    ...
    const previousConfigDirMustBe = process.env.NOT_CODEX_FAKE_CLAUDE_CONFIG_DIR_MUST_BE;
    ...
    yield* Effect.acquireRelease(
      Effect.sync(() => {
        ...
        if (input.configDirMustBe !== undefined) {
          process.env.NOT_CODEX_FAKE_CLAUDE_CONFIG_DIR_MUST_BE = input.configDirMustBe;
        } else {
          delete process.env.NOT_CODEX_FAKE_CLAUDE_CONFIG_DIR_MUST_BE;
        }
      }),
      () =>
        Effect.sync(() => {
          ...
          if (previousConfigDirMustBe === undefined) {
            ...
            process.env.NOT_CODEX_FAKE_CLAUDE_CONFIG_DIR_MUST_BE = previousConfigDirMustBe;
          }
        }),
    );
