...
import { GitCommandError, TextGenerationError } from "@notcodex/contracts";
...
> {
  return Effect.gen(function* () {
    const remoteDir = yield* makeTempDir("notcodex-git-remote-");
  ...
  const execute: GitHubCli.GitHubCli["Service"]["execute"] = (input) => {
    ...
    if (args[0] === "pr" && args[1] === "create") {
      return Effect.succeed(
        fakeGhOutput(
          (scenario.createdPrUrl ?? "https://github.com/collaborator/example-repo/pull/101") + "\n",
        ),
      );
    }
    ...
    if (args[0] === "pr" && args[1] === "view") {
      const pullRequest: FakePullRequest = scenario.pullRequest ?? {
        number: 101,
        title: "Pull request",
        url: "https://github.com/collaborator/example-repo/pull/101",
        baseRefName: "main",
...
function makeManager(input?: {
  ...
  const serverConfigLayer = ServerConfig.layerTest(process.cwd(), {
    prefix: "notcodex-git-manager-test-",
  });
...
const GitManagerTestLayer = GitVcsDriver.layer.pipe(
  Layer.provide(ServerConfig.layerTest(process.cwd(), { prefix: "notcodex-git-manager-test-" })),
  Layer.provideMerge(VcsProcess.layer),
  Layer.provideMerge(NodeServices.layer),
);
...
it.layer(GitManagerTestLayer)("GitManager", (it) => {
  it.effect("status includes PR metadata when branch already has an open PR", () =>
    Effect.gen(function* () {
      const repoDir = yield* makeTempDir("notcodex-git-manager-");
            ...
            JSON.stringify([
              {
                number: 13,
                title: "Existing PR",
                url: "https://github.com/collaborator/example-repo/pull/13",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: " https://github.com/collaborator/example-repo/pull/14 ",
                baseRefName: " main ",
            ...
            JSON.stringify([
              {
                number: 0,
                title: "invalid",
                url: "https://github.com/collaborator/example-repo/pull/0",
                baseRefName: "main",
              ...
              },
              {
                ...
                url: " https://github.com/collaborator/example-repo/pull/15 ",
                baseRefName: " main ",
            ...
            JSON.stringify([
              {
                number: 16,
                title: "Closed PR",
                url: "https://github.com/collaborator/example-repo/pull/16",
                baseRefName: "main",
              ...
              },
              {
                number: 17,
                title: "Merged PR",
                url: "https://github.com/collaborator/example-repo/pull/17",
                baseRefName: "main",
                headRefName: "feature/status-lowercase-state",
                state: "merged",
  ...
  it.effect("status returns an explicit non-repo result for non-git directories", () =>
    Effect.gen(function* () {
      const cwd = yield* makeTempDir("notcodex-git-manager-non-repo-");
      const { manager } = yield* makeManager();
  ...
  it.effect("status returns an explicit non-repo result for deleted directories", () =>
    Effect.gen(function* () {
      const rootDir = yield* makeTempDir("notcodex-git-manager-missing-dir-");
  ...
  it.effect("status briefly caches repeated lookups for the same cwd", () =>
    Effect.gen(function* () {
      ...
      const existingPr = {
        number: 113,
        title: "Cached PR",
        url: "https://github.com/collaborator/example-repo/pull/113",
        baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  headRepository: {
                    nameWithOwner: "lnieuwenhuis/notcodex",
                  },
                  headRepositoryOwner: {
                    login: "lnieuwenhuis",
                  },
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["checkout", "-b", "notcodex/pr-488/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "fork-seed",
          "git@github.com:jasonLaster/example-repo.git",
          forkDir,
        );
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/collaborator/example-repo/pull/488",
                  baseRefName: "main",
                  ...
                  isCrossRepository: true,
                  headRepository: {
                    nameWithOwner: "jasonLaster/example-repo",
                  },
                  headRepositoryOwner: {
                    login: "jasonLaster",
                  },
        ...
        const status = yield* manager.status({ cwd: repoDir });
        expect(status.refName).toBe("notcodex/pr-488/statemachine");
        expect(status.pr).toEqual({
          number: 488,
          title: "Rebase this PR on latest main",
          url: "https://github.com/collaborator/example-repo/pull/488",
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "origin",
          "git@github.com:collaborator/example-repo.git",
          originDir,
        );
        ...
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "my-org/upstream",
          "ssh://git@github.com/collaborator/example-repo.git",
          upstreamDir,
        );
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              ...
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "collaborator:effect-atom": JSON.stringify([]),
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "my-org/upstream:effect-atom": JSON.stringify([]),
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "collaborator:upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/matrixy/not-codex/pull/1518",
        ...
        expect(
          ghCalls.some((call) =>
            call.includes("pr list --head collaborator:upstream/effect-atom "),
          ),
        ).toBe(false);
        expect(
          ghCalls.some((call) =>
            ...
            JSON.stringify([
              {
                number: 22,
                title: "Merged PR",
                url: "https://github.com/collaborator/example-repo/pull/22",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 23,
                title: "Merged PR",
                url: "https://github.com/collaborator/example-repo/pull/23",
            ...
            JSON.stringify([
              {
                number: 45,
                title: "Merged PR",
                url: "https://github.com/collaborator/example-repo/pull/45",
                baseRefName: "main",
              ...
              },
              {
                number: 46,
                title: "Open PR",
                url: "https://github.com/collaborator/example-repo/pull/46",
                baseRefName: "main",
                headRefName: "feature/status-open-over-merged",
                state: "OPEN",
                updatedAt: "2026-01-30T10:00:00Z",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/collaborator/example-repo/pull/77",
                  baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/collaborator/example-repo/pull/303",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/collaborator/example-repo/pull/404",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/MaTriXy/not-codex/pull/505",
                baseRefName: "master",
            ...
            JSON.stringify([
              {
                number: 42,
                title: "Existing PR",
                url: "https://github.com/collaborator/example-repo/pull/42",
                baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/collaborator/example-repo/pull/142",
                  baseRefName: "main",
                  headRefName: "statemachine",
                  state: "OPEN",
                  isCrossRepository: true,
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["remote", "add", "fork-seed", forkDir]);
        yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
        yield* runGit(repoDir, ["checkout", "-b", "notcodex/pr-142/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "fork-seed",
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "notcodex/pr-142/statemachine": JSON.stringify([]),
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              statemachine: JSON.stringify([
                {
                  number: 41,
                  title: "Unrelated same-repo PR",
                  url: "https://github.com/collaborator/example-repo/pull/41",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
            ...
            JSON.stringify([
              {
                number: 88,
                title: "Add stacked git actions",
                url: "https://github.com/collaborator/example-repo/pull/88",
                baseRefName: "main",
  ...
  it.effect("generates PR content against the remote base when the local base is stale", () =>
    Effect.gen(function* () {
      ...
      const peerDir = yield* makeTempDir("notcodex-git-peer-");
              ...
              JSON.stringify([
                {
                  number: 188,
                  title: "Add stacked git actions",
                  url: "https://github.com/collaborator/example-repo/pull/188",
                  baseRefName: "main",
                  headRefName: "feature/no-fork-match",
                  state: "OPEN",
  ...
  it.effect("creates cross-repo PRs with the fork owner selector and default base branch", () =>
    Effect.gen(function* () {
      ...
      yield* runGit(repoDir, ["commit", "-m", "Feature commit"]);
      yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
      yield* runGit(repoDir, ["checkout", "-b", "notcodex/pr-91/statemachine"]);
      yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
      yield* configureVisibleRemoteUrlWithLocalRewrite(
        repoDir,
        "fork-seed",
      ...
      const { manager, ghCalls } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 64,
            title: "Local PR",
            url: "https://github.com/collaborator/example-repo/pull/64",
            baseRefName: "main",
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/collaborator/example-repo/pull/65",
              baseRefName: "main",
              headRefName: "feature/pr-local-upstream",
              state: "open",
              isCrossRepository: false,
              headRepositoryNameWithOwner: "collaborator/example-repo",
              headRepositoryOwnerLogin: "collaborator",
            },
            repositoryCloneUrls: {
              "collaborator/example-repo": {
                url: remoteDir,
                sshUrl: remoteDir,
              },
            },
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/collaborator/example-repo/pull/66",
              baseRefName: "main",
  ...
  it.effect("preserves both branch materialization failures when the fallback also fails", () =>
    Effect.gen(function* () {
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/collaborator/example-repo/pull/93",
            baseRefName: "main",
            headRefName: "feature/missing-fork-branch",
            state: "open",
            isCrossRepository: true,
            headRepositoryNameWithOwner: "octocat/example-repo",
      ...
      expect(error).toMatchObject({
        ...
        headRepository: "octocat/example-repo",
        headBranch: "feature/missing-fork-branch",
        localBranch: "notcodex/pr-93/feature/missing-fork-branch",
      });
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/collaborator/example-repo/pull/177",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 81,
            title: "Fork PR",
            url: "https://github.com/collaborator/example-repo/pull/81",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 82,
            title: "Local Fork PR",
            url: "https://github.com/collaborator/example-repo/pull/82",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/collaborator/example-repo/pull/78",
            baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              number: 91,
              title: "Fork main PR",
              url: "https://github.com/collaborator/example-repo/pull/91",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("notcodex/pr-91/main");
        expect(result.worktreePath).not.toBeNull();
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/collaborator/example-repo/pull/92",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("notcodex/pr-92/main");
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/collaborator/example-repo/pull/83",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/collaborator/example-repo/pull/184",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 79,
            title: "Root-only PR",
            url: "https://github.com/collaborator/example-repo/pull/79",
            baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/collaborator/example-repo/pull/201",
                baseRefName: "main",
