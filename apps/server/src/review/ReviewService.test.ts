  ...
  it.effect("rejects diff preview cwd outside the configured workspace roots", () =>
    Effect.gen(function* () {
      ...
      const workspaceRoot = yield* fs.makeTempDirectoryScoped({
        prefix: "notcodex-review-workspace-",
      });
      const outsideRoot = yield* fs.makeTempDirectoryScoped({ prefix: "notcodex-review-outside-" });
      const baseDir = yield* fs.makeTempDirectoryScoped({ prefix: "notcodex-review-base-" });
