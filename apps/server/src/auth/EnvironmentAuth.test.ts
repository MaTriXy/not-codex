...
import { AuthAdministrativeScopes } from "@notcodex/contracts";
...
const makeServerConfigLayer = (overrides?: Partial<ServerConfig.ServerConfig["Service"]>) =>
  Layer.effect(
    ...
    Layer.provide(ServerConfig.layerTest(process.cwd(), { prefix: "notcodex-auth-server-test-" })),
  );
