...
<html lang="en">
  <head>
    ...
    <title>Not Codex Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <div class="next"><strong>Next:</strong> return to the terminal to finish Not Codex Connect setup. You can close this window.</div>
      </section>
    </main>
  </body>
</html>`;
