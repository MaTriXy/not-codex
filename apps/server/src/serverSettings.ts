...
import { type DeepPartial, deepMerge } from "@notcodex/shared/Struct";
import { fromJsonStringPretty, fromLenientJson } from "@notcodex/shared/schemaJson";
...
// Preserve explicit opt-ins and opt-outs because provider history cannot
// reconstruct a user's choice before first use.
