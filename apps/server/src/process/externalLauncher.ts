...
import { isCommandAvailable, resolveSpawnCommand } from "@notcodex/shared/shell";
...
// per-command cache lookups in @notcodex/shared/shell.
//
...
// command-resolution cache in @notcodex/shared/shell, so a backward wall-clock
...
>()("notcodex/process/externalLauncher") {}
