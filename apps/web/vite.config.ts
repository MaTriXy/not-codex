...
const configuredRelayUrl = repoEnv.VITE_NOT_CODEX_RELAY_URL?.trim() || "";
...
const sourcemapEnv = process.env.NOT_CODEX_WEB_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_NOT_CODEX_RELAY_URL": JSON.stringify(configuredRelayUrl),
