...
export const PERSISTED_STATE_KEY = "notcodex:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "notcodex:renderer-state:v8",
  "notcodex:renderer-state:v7",
  "notcodex:renderer-state:v6",
  "notcodex:renderer-state:v5",
  "notcodex:renderer-state:v4",
  "notcodex:renderer-state:v3",
