...
describe("formatWorkspaceRelativePath", () => {
  it("formats absolute workspace paths from the workspace root", () => {
    expect(
      formatWorkspaceRelativePath(
        "C:/Users/mike/dev-stuff/notcodex/apps/web/src/session-logic.ts:501",
        "C:/Users/mike/dev-stuff/notcodex",
      ),
    ).toBe("notcodex/apps/web/src/session-logic.ts:501");
  });
  ...
  it("keeps paths already rooted at the workspace label stable", () => {
    expect(
      formatWorkspaceRelativePath(
        "notcodex/apps/web/src/session-logic.ts:501",
        "C:/Users/mike/dev-stuff/notcodex",
      ),
    ).toBe("notcodex/apps/web/src/session-logic.ts:501");
  });
  ...
  it("preserves columns when present", () => {
    expect(
      formatWorkspaceRelativePath(
        "/C:/Users/mike/dev-stuff/notcodex/apps/web/src/session-logic.ts:501:9",
        "C:/Users/mike/dev-stuff/notcodex",
      ),
    ).toBe("notcodex/apps/web/src/session-logic.ts:501:9");
  });
});
