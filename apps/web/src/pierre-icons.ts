...
const PIERRE_ICON_SPRITE_ID = "notcodex-pierre-file-icon-sprite";

const NOT_CODEX_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="notcodex-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="notcodex-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="notcodex-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="notcodex-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="notcodex-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="notcodex-file-icon-pnpm" viewBox="0 0 32 32">
...
export const NOT_CODEX_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: NOT_CODEX_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "notcodex-file-icon-package-json",
    "tsconfig.json": "notcodex-file-icon-tsconfig",
    "agents.md": "notcodex-file-icon-agents",
    "claude.md": "notcodex-file-icon-claude",
    "readme.md": "notcodex-file-icon-readme",
    "pnpm-lock.yaml": "notcodex-file-icon-pnpm",
    "pnpm-workspace.yaml": "notcodex-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(NOT_CODEX_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${NOT_CODEX_FILE_ICON_SPRITE}`;
