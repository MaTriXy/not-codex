...
/**
 * Accounts that opted out of the post-sign-in Not Codex Connect onboarding wizard
 * ("Don't show this again"). The wizard otherwise shows on every sign-in,
 * since sign-out clears the connected environments.
 */
export const CONNECT_ONBOARDING_OPT_OUT_STORAGE_KEY = "notcodex:connect-onboarding-opt-out:v1";
