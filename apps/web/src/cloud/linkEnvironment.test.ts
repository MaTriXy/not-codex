...
import { RelayWebClientId } from "@notcodex/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_NOT_CODEX_RELAY_URL", "https://relay.example.test");
