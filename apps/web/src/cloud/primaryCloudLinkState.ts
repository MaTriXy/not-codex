...
import type { EnvironmentCloudLinkStateResult } from "@notcodex/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Not Codex Connect link state.";
  }
