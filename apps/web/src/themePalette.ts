...
export const CUSTOM_THEMES_STORAGE_KEY = "notcodex:themes:v1";
export const THEME_FOLLOW_SYSTEM_STORAGE_KEY = "notcodex:theme-follow-system";
export const THEME_APPEARANCE_MODE_STORAGE_KEY = "notcodex:theme-appearance-mode";
export const THEME_HALVES_STORAGE_KEY = "notcodex:theme-halves:v1";
...
// Older builds stored the dark flagship palette as a separate theme. Keep
 ...
 */
// Adapted from the original flagship palette. Translucent chat surfaces are
...
const NOT_CODEX_LIGHT_COLORS: ThemeColors = {
  ...
  // The light chrome controls sit on the pale gradient-noise surface,
  ...
  // The flagship palette uses a light lavender code surface in light mode. Keeping the
  // dark plum pair here also leaked the dark palette into Not Codex's diffs.
  codeBackground: "#f5ecf9",
  codeForeground: "#673c8b",
  // The live sidebar is transparent over the outer shell. Use that
...
const NOT_CODEX_DARK_COLORS: ThemeColors = {
  ...
  // Cards and panels stay in the flagship plum surface family. Near-black here
  ...
  // Diffs and file previews are full workspace surfaces in Not Codex. Keep them
  ...
  // The flagship palette draws the chat panel edge in this muted pink. The resize rail uses
...
/**
 * The palette Not Codex wears with no theme installed, captured from the app's
...
/**
 * The standard Not Codex look as a theme palette, for seeding a new theme when
 * no theme is installed. Distinct from {@link getDefaultThemeColors}, which
 * carries the flagship Not Codex palette used to fill roles omitted by theme
 * files.
 */
...
/**
 * The status colors Not Codex shows without a theme, read from the app's own
...
/**
 * A companion action color in the flagship mold. This gives send buttons,
