...
import { pullRequestHostOf, ThreadId } from "@notcodex/contracts";
import type {
  EnvironmentId,
  ProjectId,
    ...
    <>
      {!capabilityKnown ? (
        ...
        <PullRequestsUnavailableState
          ...
          error="Update your Not Codex servers to browse pull requests."
        />
      ) : firstLoad ? (
        <PullRequestListGhost rows={7} />
    ...
    <SidebarInset className="h-dvh min-h-0 overflow-hidden overscroll-y-none bg-background text-foreground">
      <div className="relative flex min-h-0 flex-1">
        ...
        {rightPanelState.isOpen && activePullRequestSurface && panelEnvironmentId !== null ? (
          <RightPanelTabs
            mode="inline"
            widthStorageKey="notcodex:pull-request-panel-width"
