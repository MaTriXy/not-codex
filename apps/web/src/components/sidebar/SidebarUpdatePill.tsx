        ...
        <TooltipTrigger
          render={
            <button
              ...
              className={cn(
                "inline-flex size-8 items-center justify-center rounded-lg outline-hidden ring-ring transition-colors enabled:cursor-pointer focus-visible:ring-2 disabled:cursor-not-allowed",
                showUpdateIconState
