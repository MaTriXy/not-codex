...
import { serializeComposerFileLink } from "@notcodex/shared/composerTrigger";
import { createModelSelection, normalizeModelSlug } from "@notcodex/shared/model";
import {
  memo,
  useCallback,
  useEffect,
...
import {
  RuntimeModeMenuOption,
  runtimeModeConfig,
  runtimeModeOptions,
} from "./RuntimeModeMenuOption";
...
import type { UnifiedSettings } from "@notcodex/contracts/settings";
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const addComposerImages = async (files: File[]) => {
    ...
    for (const file of files) {
      ...
      const attachmentFile = prepared.file;
    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "chat-composer-glass rounded-[20px] border transition-[background-color] duration-200 has-focus-visible:border-ring/55",
            isDragOverComposer
