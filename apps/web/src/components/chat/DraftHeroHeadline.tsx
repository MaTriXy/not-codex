...
export function DraftHeroHeadline({
  ...
  const projectSelector = shouldShowProjectMenu ? (
    ...
    <button
      ...
      className="pointer-events-auto inline cursor-pointer border-current border-b border-dotted align-baseline text-muted-foreground/60 underline-offset-8 transition-opacity hover:opacity-75 focus-visible:rounded-sm focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring"
    >
