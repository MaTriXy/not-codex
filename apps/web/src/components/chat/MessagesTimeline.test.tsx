import { EnvironmentId, MessageId } from "@notcodex/contracts";
...
beforeAll(async () => {
  ...
  // Keep cold module transformation out of individual behavior-test timeouts.
        ...
        timelineEntries={[
          buildUserTimelineEntry(
            [
              ...
              "  1 | collaborator@mac effect-http-ws-cli % bun i",
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/notcodex/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/notcodex"
      />,
    );

    expect(markup).toContain("notcodex/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/notcodex/apps/web/src/session-logic.ts");
  });
