import type { DiscoveredLocalServer } from "@notcodex/contracts";
import { isLoopbackHost } from "@notcodex/shared/preview";
...
export interface PreviewableServer extends DiscoveredLocalServer {
   ...
   */
  listening: boolean;
  /** Stable pre-resolution URL used for environment-scoped history. */
  requestedUrl: string;
}
