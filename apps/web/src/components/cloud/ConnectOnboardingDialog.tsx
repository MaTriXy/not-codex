...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@notcodex/contracts";
...
/**
 * Post-sign-in onboarding wizard for Not Codex Connect. Opens on every in-session
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "Not Codex Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Not Codex Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Not Codex Connect."
