import type { EnvironmentId, ServerSelfUpdateCapability } from "@notcodex/contracts";
import type { ServerUpdateStage, ServerUpdateState } from "@notcodex/client-runtime/state/server";
import {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toastManager.add({
        ...
        description: `Reconnected on notcodex@${result.value.targetVersion}.`,
      });
    } finally {
