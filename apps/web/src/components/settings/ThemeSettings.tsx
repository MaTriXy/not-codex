...
export function ThemeLibrary({
  ...
  // half belongs to the Classic card (a null owner), so a fresh install
  // shows the neutral fallback selected instead of nothing.
  ...
  return (
    <div className="space-y-3">
      <p className="px-3 text-[13px] leading-[1.45] text-muted-foreground/80 sm:px-4">
        Choose how Not Codex looks. Use a built-in theme or make your own.
      </p>
