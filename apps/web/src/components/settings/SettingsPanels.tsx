          ...
          control={
            <Select
              ...
              onValueChange={(value) => {
                ...
                if (selectionUrl !== null) window.location.assign(selectionUrl);
              }}
            >
...
export function useSettingsRestore(onRestored?: () => void) {
  const { theme, setTheme, themeHalves } = useTheme();
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Not Codex looks across the app."
          resetAction={
            theme !== "system" ? (
