import { type KeybindingCommand, type FilesystemBrowseEntry } from "@notcodex/contracts";
import type { SidebarThreadSortOrder } from "@notcodex/contracts/settings";
...
export function buildThreadActionItems<TThread extends BuildThreadActionItemsThread>(input: {
  ...
  /** Optional rich description. Falls back to the compact text description. */
