import { scopeProjectRef, scopedThreadKey } from "@notcodex/client-runtime/environment";
import {
...
import type { ScopedThreadRef, ThreadId } from "@notcodex/contracts";
...
/**
 * The per-thread action menu (settle, snooze, rename, copy, delete…) as
  ...
  const openMenu = useCallback(
    (position: { x: number; y: number }) => {
      ...
      void (async () => {
        ...
        const isRegeneratingTitle = false;
