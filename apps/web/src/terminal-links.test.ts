  ...
  it("resolves relative paths against cwd", () => {
    expect(
      resolvePathLinkTarget(
        ...
        "/Users/collaborator/project",
      ),
    ).toBe("/Users/collaborator/project/src/components/ThreadTerminalDrawer.tsx:42:7");
  });

  it("keeps absolute paths unchanged", () => {
    expect(
      resolvePathLinkTarget(
        "/Users/collaborator/project/src/main.ts:12",
        "/Users/collaborator/project",
      ),
    ).toBe("/Users/collaborator/project/src/main.ts:12");
  });

  it("keeps Windows absolute paths with forward slashes unchanged", () => {
    expect(
      resolvePathLinkTarget(
        "C:/Users/collaborator/project/src/main.ts:12",
        "C:\\Users\\collaborator\\project",
      ),
    ).toBe("C:/Users/collaborator/project/src/main.ts:12");
  });
});
