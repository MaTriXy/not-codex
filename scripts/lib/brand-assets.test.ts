...
describe("brand-assets", () => {
  ...
  it("maps tracked public web assets to development icons", () => {
  ...
  it.effect("keeps tracked public web icons byte-identical to development assets", () =>
    Effect.gen(function* () {
      ...
      for (const override of DEVELOPMENT_PUBLIC_ICON_OVERRIDES) {
        assert.deepStrictEqual(
          yield* fs.readFile(path.join(repoRoot, override.targetRelativePath)),
          yield* fs.readFile(path.join(repoRoot, override.sourceRelativePath)),
        );
      }
