export const BRAND_ASSET_PATHS = {
  originalBrandLockupPng: "assets/prod/not-codex-original-lockup.png",
  ...
  productionWebFavicon32Png: "assets/prod/notcodex-black-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/notcodex-black-web-apple-touch-180.png",
