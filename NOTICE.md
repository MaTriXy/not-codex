...
[T3 Code](https://github.com/pingdotgg/t3code), originally developed by T3 Tools Inc.
The T3 Code portions are used and distributed under the MIT License.

Original T3 Code portions:

Copyright (c) 2026 T3 Tools Inc.

Original Not Codex modifications and materials:

Copyright (c) 2026 MaTrixy (Yossi Elkrief)

The source code is distributed under the MIT License in [LICENSE](./LICENSE), except where a file or
directory carries a different notice. The Not Codex brand is subject to the separate terms in
