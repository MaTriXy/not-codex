...
export const WS_METHODS = {
  ...
  // Pull request methods (read-only foundation)
 ...
 * Not the persisted Not Codex Review model. Future review sessions should use
...
export const WsAutomationListDefinitionsRpc = Rpc.make(AUTOMATION_WS_METHODS.listDefinitions, {
  payload: AutomationRpcSchemas.listDefinitions.input,
  success: AutomationRpcSchemas.listDefinitions.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationGetDefinitionRpc = Rpc.make(AUTOMATION_WS_METHODS.getDefinition, {
  payload: AutomationRpcSchemas.getDefinition.input,
  success: AutomationRpcSchemas.getDefinition.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationCreateDefinitionRpc = Rpc.make(AUTOMATION_WS_METHODS.createDefinition, {
  payload: AutomationRpcSchemas.createDefinition.input,
  success: AutomationRpcSchemas.createDefinition.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationUpdateDefinitionRpc = Rpc.make(AUTOMATION_WS_METHODS.updateDefinition, {
  payload: AutomationRpcSchemas.updateDefinition.input,
  success: AutomationRpcSchemas.updateDefinition.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationDeleteDefinitionRpc = Rpc.make(AUTOMATION_WS_METHODS.deleteDefinition, {
  payload: AutomationRpcSchemas.deleteDefinition.input,
  success: AutomationRpcSchemas.deleteDefinition.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationRunNowRpc = Rpc.make(AUTOMATION_WS_METHODS.runNow, {
  payload: AutomationRpcSchemas.runNow.input,
  success: AutomationRpcSchemas.runNow.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationCancelRunRpc = Rpc.make(AUTOMATION_WS_METHODS.cancelRun, {
  payload: AutomationRpcSchemas.cancelRun.input,
  success: AutomationRpcSchemas.cancelRun.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationRetryRunRpc = Rpc.make(AUTOMATION_WS_METHODS.retryRun, {
  payload: AutomationRpcSchemas.retryRun.input,
  success: AutomationRpcSchemas.retryRun.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationListRunsRpc = Rpc.make(AUTOMATION_WS_METHODS.listRuns, {
  payload: AutomationRpcSchemas.listRuns.input,
  success: AutomationRpcSchemas.listRuns.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationGetRunRpc = Rpc.make(AUTOMATION_WS_METHODS.getRun, {
  payload: AutomationRpcSchemas.getRun.input,
  success: AutomationRpcSchemas.getRun.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
export const WsAutomationSubscribeRpc = Rpc.make(AUTOMATION_WS_METHODS.subscribe, {
  ...
  success: AutomationRpcSchemas.subscribe.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
  stream: true,
});
export const WsAutomationListTemplatesRpc = Rpc.make(AUTOMATION_WS_METHODS.listTemplates, {
  payload: AutomationRpcSchemas.listTemplates.input,
  success: AutomationRpcSchemas.listTemplates.output,
  error: Schema.Union([AutomationRequestError, EnvironmentAuthorizationError]),
});
...
export const WsIntegrationListRunsRpc = Rpc.make(INTEGRATION_WS_METHODS.listRuns, {
  payload: IntegrationRpcSchemas.listRuns.input,
  success: IntegrationRpcSchemas.listRuns.output,
  error: Schema.Union([IntegrationRequestError, EnvironmentAuthorizationError]),
});
export const WsIntegrationGetRunRpc = Rpc.make(INTEGRATION_WS_METHODS.getRun, {
  payload: IntegrationRpcSchemas.getRun.input,
...
export const WsIntegrationResumeRunRpc = Rpc.make(INTEGRATION_WS_METHODS.resumeRun, {
  payload: IntegrationRpcSchemas.resumeRun.input,
  success: IntegrationRpcSchemas.resumeRun.output,
  error: Schema.Union([IntegrationRequestError, EnvironmentAuthorizationError]),
});
export const WsIntegrationRetryRunRpc = Rpc.make(INTEGRATION_WS_METHODS.retryRun, {
  payload: IntegrationRpcSchemas.retryRun.input,
  success: IntegrationRpcSchemas.retryRun.output,
  error: Schema.Union([IntegrationRequestError, EnvironmentAuthorizationError]),
});
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsAutomationListDefinitionsRpc,
  WsAutomationGetDefinitionRpc,
  WsAutomationCreateDefinitionRpc,
  WsAutomationUpdateDefinitionRpc,
  WsAutomationDeleteDefinitionRpc,
  WsAutomationRunNowRpc,
  WsAutomationCancelRunRpc,
  WsAutomationRetryRunRpc,
  ...
  WsIntegrationResumeRunRpc,
  WsIntegrationRetryRunRpc,
);
