...
/**
 * Wire codec for server-to-client arrays whose element unions grow over time.
 * Unknown elements from a newer server are dropped instead of rejecting the
 * entire payload; encoding remains the ordinary array encoding.
 */
...
export const AutomationRunEventId = makeEntityId("AutomationRunEventId");
export type AutomationRunEventId = typeof AutomationRunEventId.Type;
