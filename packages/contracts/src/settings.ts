...
export const ClientSettingsSchema = Schema.Struct({
  // Retained for settings-file compatibility; plan steps now render inline.
...
// Kept as a deep-import-compatible re-export after moving the schema to
// environment.ts, where orchestration contracts can use it without a cycle.
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-notcodex/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Not Codex spawn the server when needed.",
        providerSettingsForm: {
...
export const PiProjectTrust = Schema.Literals(["ignore", "trust"]);
...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    agentDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description:
          "Optional PI_CODING_AGENT_DIR used to isolate this instance's credentials, extensions, and sessions.",
        providerSettingsForm: { placeholder: "~/.pi/agent", clearWhenEmpty: "omit" },
      }),
    ),
    projectTrust: PiProjectTrust.pipe(
      Schema.withDecodingDefault(Effect.succeed("ignore" as const)),
      Schema.annotateKey({
        title: "Project resources",
        description:
          "Trust project-local Pi extensions, skills, and prompts. Trusted extensions execute with the Pi process permissions.",
      }),
    ),
    customModels: Schema.Array(Schema.String).pipe(
      Schema.withDecodingDefault(Effect.succeed([])),
  ...
  { order: ["binaryPath", "agentDir", "projectTrust"] },
);
...
export const ServerSettings = Schema.Struct({
  // Deliberately a fresh key: prior streaming opt-ins reset to the faster buffered default.
