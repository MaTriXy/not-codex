...
import { RelayManagedEndpoint } from "@notcodex/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@notcodex/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@notcodex/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
