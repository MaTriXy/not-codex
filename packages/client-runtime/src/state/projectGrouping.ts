...
import type { ClientSettings } from "@notcodex/contracts/settings";
...
/**
 * Build logical groups while retaining every physical project as a concrete
 * navigation and task-creation target. Duplicate registrations at the same
 * path collapse to their freshest representation without losing project refs.
 */
