import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@notcodex/contracts";
import { resolveRemotePairingTarget } from "@notcodex/shared/remote";
...
>()("@notcodex/client-runtime/connection/onboarding/ConnectionOnboarding") {}
