 ...
 *
 * ```ts
 * import { parseYaml } from "@notcodex/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@notcodex/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@notcodex/shared/schemaYaml"
 *
