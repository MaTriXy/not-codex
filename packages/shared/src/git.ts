...
export const WORKTREE_BRANCH_PREFIX = "notcodex";
// Canonical form is `notcodex/<8 hex>`. Older mobile builds generated
// `notcodex/<uuid>` via Crypto.randomUUID() (always RFC 4122 v4), so the matcher
// also accepts exactly that shape to keep those threads eligible for branch
// regeneration without loosening beyond what was ever generated.
