...
export const RELAY_LINK_PROOF_TYP = "notcodex-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "notcodex-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "notcodex-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "notcodex-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "notcodex-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "notcodex-env-activity+jwt";
