...
export const HostProcessWorkingDirectory = Context.Reference<string>(
  "@notcodex/shared/hostProcess/HostProcessWorkingDirectory",
  {
...
/** Undefined on platforms without POSIX user ids (Windows). */
export const HostProcessUserId = Context.Reference<number | undefined>(
  "@notcodex/shared/hostProcess/HostProcessUserId",
  {
