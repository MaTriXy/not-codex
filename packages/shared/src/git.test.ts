import type { VcsStatusRemoteResult, VcsStatusResult } from "@notcodex/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:NotCodex/NotCodex.git")).toBe(
      "github.com/notcodex/notcodex",
    );
    expect(normalizeGitRemoteUrl("https://github.com/NotCodex/NotCodex.git")).toBe(
      "github.com/notcodex/notcodex",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/NotCodex/NotCodex")).toBe(
      "github.com/notcodex/notcodex",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:NotCodex/platform/NotCodex.git")).toBe(
      "gitlab.com/notcodex/platform/notcodex",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/NotCodex/platform/NotCodex.git")).toBe(
      "gitlab.com/notcodex/platform/notcodex",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:NotCodex/NotCodex.git"),
    ).toBe("NotCodex/NotCodex");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/NotCodex/NotCodex.git"),
    ).toBe("NotCodex/NotCodex");
  });
});
